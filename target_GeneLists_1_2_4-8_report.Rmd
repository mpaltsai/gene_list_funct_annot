---
title: "target_GeneLists_1_2_4-8"
author: "Ismini"
date: "August 12, 2019"
...
cat("common genes between new_targets and genes_batch:")
...
cat("common genes between new_targets and genes_OldProt:")
...
cat("common genes between new_targets and genes_oldVSall:")
...
write.table(final_new_targets_genes_batch[,1:512], "final_GeneLists_1_2_4-8_genes_batch_part1.csv", sep=",", na="")
write.table(final_new_targets_genes_batch[,513:1024], "final_GeneLists_1_2_4-8_genes_batch_part2.csv", sep=",", na="")
...
write.table(final_new_targets_genes_OldProt, "final_GeneLists_1_2_4-8_genes_OldProt.csv", sep=",", na="")
...
write.table(final_new_targets_genes_OldVSall[,1:544], "final_GeneLists_1_2_4-8_genes_OldVSall_part1.csv", sep=",", na="")
...
dimnames(sign_new_targets) <- list(c("Gene list", "Comparison", "pvalue", "Bonferroni correction", "BH correction", "q values", "common genes", rep("", 231)), c(1:length(sign_p_values_index)))


write.table(sign_new_targets[,1:649], "sign_GeneLists_1_2_4-8_part1.csv", sep=",", na="")
write.table(sign_new_targets[,650:1298], "sign_GeneLists_1_2_4-8_part2.csv", sep=",", na="")
...
dimnames(sign_common_mat) <- list(c("Gene list", "Comparison", "common genes", rep("", 231)), c(1:length(sign_fdr_index)))
#sign_fdr_genes <- unique(sign_common[,!is.na(sign_common) & !sign_common==""])
#sign_fdr_genes

write.table(sign_common_mat[,1:576], "sign_fdr_genes_part1.csv", sep=",", na="")
write.table(sign_common_mat[,577:1152], "sign_fdr_genes_part2.csv", sep=",", na="")
