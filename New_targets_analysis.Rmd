...
targets = read.csv("New_Targets.csv", sep=",", header = F,
...
write.table(final_targets_genes_batch, "final_new_targets_genes_batch.csv", sep=",", na="")
```
...
write.table(final_targets_genes_OldProt, "final_new_targets_genes_OldProt.csv", sep=",", na="")
...
write.table(final_targets_genes_OldVSall, "final_new_targets_genes_OldVSall.csv", sep=",", na="")
...
write.table(final_targets_genes_1_2_4_8, "final_new_targets_genes_1_2_4_8.csv", sep=",", na="")
...
write.table(sign_targets, "sign_new_targets.csv", sep=",", na="")
...
###Mus musculus
funct_annot_mm = isws_etsi(result_mm, sign_common, file_name="New_targets")
...
write.table(super_mat_mm[,1:9], "isws_etsi_mus_musculus_new_targets.csv", sep=",",  na="", row.names = FALSE)

###Homo sapiens
funct_annot_hs = isws_etsi(result_hs, sign_common, file_name="New_targets")
...
write.table(super_mat_hs[,1:9], "isws_etsi_homo_sapiens_new_targets.csv", sep=",",  na="", row.names = FALSE)

save.image(file="New_targets_work_space.RData")
```
