...
targets = read.csv("Frog_Clusters.csv", header=T, sep=',')
...
setwd("/home/ismini/Documents/bioinfo-grad/mavrothalassitis/Frog_Clusters/")
...
write.table(final_targets_genes_batch, "final_Frog_Clusters_genes_batch.csv", sep=",", na="")
```
...
write.table(final_targets_genes_OldProt, "final_Frog_Clusters_genes_OldProt.csv", sep=",", na="")
...
write.table(final_targets_genes_OldVSall, "final_Frog_Clusters_genes_OldVSall.csv", sep=",", na="")
...
write.table(final_targets_genes_1_2_4_8, "final_Frog_Clusters_genes_1_2_4_8.csv", sep=",", na="")
...
write.table(sign_targets[,1:618], "sign_Frog_Clusters_part1.csv", sep=",", na="")
write.table(sign_targets[,619:1236], "sign_Frog_Clusters_part2.csv", sep=",", na="")
...
#sign_fdr_genes
dim(sign_common_mat)
write.table(sign_common_mat[,1:566], "sign_fdr_genes_Frog_Clusters_part1.csv", sep=",", na="")
write.table(sign_common_mat[,567:1131], "sign_fdr_genes_Frog_Clusters_part2.csv", sep=",", na="")
...
###Mus musculus
funct_annot_mm = isws_etsi(result_mm, sign_common, file_name = "Frog_Clusters")
...
write.table(super_mat_mm[,1:9], "isws_etsi_mus_musculus_Frog_Clusters.csv", sep=",",  na="", row.names = FALSE)

###Homo sapiens
funct_annot_hs = isws_etsi(result_hs, sign_common, file_name = "Frog_Clusters")
...
write.table(super_mat_hs[,1:9], "isws_etsi_homo_sapiens_Frog_Clusters.csv", sep=",",  na="", row.names = FALSE)

save.image(file="Frog_Clusters_work_space.RData")
```
